    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        image: function() 
        {
           ...
           {
				var extension = '';
			   $('#galerie_bo div img').each(function()
				{
					var numero = $(this).attr('src').split('/medias/media')[1].split('_')[0];
					var extension = $(this).attr('src').split('_g.')[1];
					if(numero == num)
					{
						img = '../img/medias/media' + num + '_g.' + extension;
					}
				});
        ...
        {        
           ...
           if(num != null)
           {
             var iframe_video='<iframe src=\"http://www.youtube.com/embed/' + num + '?wmode=transparent\" frameborder=\"0\" ></iframe>';                 
    ...
    jHtmlArea.defaultOptions = {
        ...
        ["link", "unlink", "image", "video", "horizontalrule"],
        ["p", "h1", "h2", "h3", "h4", "h5", "h6"],
        ["cut", "copy", "paste"]
    ],
        css: null,
        toolbarText: {
            ...
            html: "Code HTML", video:"Vidéo", size_image:"Taille de l'image"
        },
        url_image: 'http://'
    };
    var priv = {
        ...
        attachEditorEvents: function (bloc_wysiwyg) {
            ...
            {
              if($(this).parent().attr('id') != 'bloc_img')
              {  
