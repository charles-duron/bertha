    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        image: function() 
        {
           ...
           {
				var extension = '';
			   $('#galerie_bo .image img').each(function()
				{
					var numero = $(this).attr('src').split('/medias/media')[1].split('.')[0];
					var extension = $(this).attr('src').split('/medias/media')[1].split('.')[1];
					if(numero == num)
					{
						img = '../img/medias/media' + num + '.' + extension;
					}
				});
        ...
        player: function() 
        {
           ...
           if(num != null)
           {
  			   $('#galerie_bo .audiojs audio').each(function()
				{
					var numero = $(this).attr('src').split('/medias/media')[1].split('.')[0];
					var extension = $(this).attr('src').split('/medias/media')[1].split('.')[1];
					if(numero == num)
					{
						audio = '../img/medias/media' + num + '.' + extension;
					}
				});
