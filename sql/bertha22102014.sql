...
--
-- Client: localhost
-- Généré le: Mer 22 Octobre 2014 à 20:23
...
(5, 1, 'Soin visage anti-Ã¢ge', '<p><img alt="gaston idee" src="../img/medias/media47.jpg" style="width: 10%; float: left;"><span style="font-size: 14px;">jg kjg kgjk gk hgh hjg f ghjghj ghjg hghghghghg h ghghk hgh hg h ghg hkgg jjfbfdbdsf</span></p><p></p><br>', '2014-02-10', '2014-10-31', '2014-10-20 18:03:06', 'oui'),
(6, 2, 'Voici une deuxiÃ¨me actu', 'soin anti-cellulite [44]<div><br><br></div>', '2014-02-01', '2014-10-31', '2014-10-20 17:30:50', 'oui'),
(8, 1, 'Lancement de mon super site', 'Bonjour, je lance mon super nouveau site :&nbsp; <a href="http://www.beew.fr">beew.fr</a><img src="../img/medias/media48.png" alt="logo beew creation site internet et webdesign" style="width: 3%;"><div><br><div></div><div>Charles Duron</div></div>', '2014-09-29', '2014-10-25', '2014-10-20 17:09:11', 'oui');
...
(9, 'robert', 'sideshow', 'tahitibob0@yahoo.fr', 'beew', 'test', 'Dear mr Sideshow.\r\n\r\nThanks for your test mail.\r\n\r\nBest regards,\r\nyourself\r\rtest de la boite mail\r\n1, 2', '0000-00-00 00:00:00', 1, 4);
...
(88, 3, 'dermea', '../templates/dermea_3.css'),
(89, 3, 'menu', '../templates/menu_3.css'),
(92, 4, 'beew', ''),
(93, 4, 'front', '');
...
(8, 1, 'Promo 2 boules', 'Je paie mon boule ce mois-ci.<div>Venez nombreux.</div><div><img src="../img/medias/media44.jpg" alt="le marsupilami" style="width: 10%;"></div>', '16cff6', '2014-10-06', '2014-11-16', 'oui'),
(9, 1, 'Le cÃ´ne en prime', 'Et juste aujourd''hui, vous avez droit Ã  un gros cÃ´ne.<div>Mais chut, c''est un secret ;)</div>', 'f4290d', '2014-10-07', '2014-10-07', 'oui'),
(10, 1, 'Les boules du dimanche', 'C''est dimanche les enfants...<div>Les bouuuuuuuuuuuuuuuuuuuuules.</div>', '70d352', '2014-10-19', '2014-10-19', 'oui'),
(11, 2, 'Brit B', 'BBBBBBBBBBBBB', 'f7d30d', '2014-10-19', '2014-10-31', 'oui');
...
(46, 'gaston-et-ses-tortues', 'Gaston promÃ¨ne ses tortues', '', 'jpg', 1, 'oui', 'oui'),
...
(50, 'play-for-fun-you-shall-not-pass', 'une video play for fun de hsfr : you shall not pass', 'https://www.youtube.com/watch?v=lnORfF6XCmM', '', 4, 'non', 'non'),
(51, 'New-lands', 'New lands de Justice sur l''album Access all arenas', '', 'mp3', 3, 'non', 'non'),
(52, 'Encore', 'Encore de Justice sur l''album Access all arenas', '', 'mp3', 3, 'non', 'non'),
(53, 'ogtv', 'ogtv', 'https://www.youtube.com/watch?v=8j9to3Ruvp4', '', 4, 'non', 'non'),
(63, 'mon-cv', 'mon beau cv qu''il est joli', '', 'pdf', 2, 'non', 'non'),
(65, 'nigel-bradford', 'nigel nous joue un petit morceau de musique', 'https://www.youtube.com/watch?v=BhDCYfzPNHw', '', 4, 'non', 'non'),
(69, 'wot', 'wot', 'https://www.youtube.com/watch?v=EWKsRsszE8Y', '', 4, 'non', 'non'),
(70, 'doubleglenhansard', 'affiche concert hansard', '', 'jpg', 1, 'oui', 'oui'),
(72, 'marsu-et-le-gorille', 'le marsupliami joue avec un gorille', '', 'jpg', 1, 'oui', 'oui');
...
(60, 13, 1, 4, 'lokijnhgmlk', 'non', '', 'test nigel', 'test nigel', 'oui', 'non', 'du texte<div><br></div><div><img src="../img/medias/media44.jpg" alt="le marsupilami" style="width: 10%; float: left;"></div><div><br></div><div><br></div><div><br></div><div><br></div><div><img src="../img/icones/music.png" class="no_front"><div class="audiojs"><audio src="../img/medias/media52.mp3" preload="auto"></audio></div></div><div><br></div><div><br></div><div><br></div>', '', '', '2014-10-12', 0, 'nigel', 'Nos soins test nigel test nigel du texte   '),
(61, 17, 4, 4, 'mumus', 'oui', '', 'brit music', 'brit mus', 'oui', 'oui', '<img src="../img/icones/music.png" class="no_front"><div class="audiojs"><audio src="../img/medias/media51.mp3" preload="auto"></audio></div><div>another one ?</div><div><img src="../img/icones/music.png" class="no_front"><div class="audiojs"><audio src="../img/medias/media52.mp3" preload="auto"></audio></div></div>', '<img alt="le marsupilami" src="../img/medias/media44.jpg" style="width: 50%;">', '<img alt="logo beew creation site internet et webdesign" src="../img/medias/media48.png">', '2014-10-20', 0, 'la-brit-musique', ''),
(62, 13, 1, 4, 'musique', 'oui', '', 'Musique', 'musique', 'oui', 'oui', 'Justice :<div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>- New lands :</div><div><img src="../img/icones/music.png" class="no_front"><div class="audiojs"><audio alt="New lands de Justice sur l''album Access all arenas" src="../img/medias/New-lands.mp3" preload="auto"></audio></div></div></blockquote>David &amp; Eskilax<br><div><div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div><iframe src="http://www.youtube.com/embed/lnORfF6XCmM?wmode=transparent" frameborder="0"></iframe></div></blockquote><div><br></div><div>BD:</div><div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div>- Marsu -</div><div><img alt="marsupilami gorille" src="../img/medias/marsu-et-le-gorille.jpg" style="width: 25%; margin: 1% 2%;"></div><div></div></blockquote></div></div></div></div>', '', '', '2014-10-21', 0, 'musique', '');
...
INSERT INTO `parametres` (`id_parametre`, `id_template`, `id_font`, `taille_font`, `titre_site`, `mail_retour`, `mail_reponse`, `id_theme`, `logo`, `favicon`, `objet_mail`, `message_mail`, `titre_flux`, `description_flux`, `rss`, `reseaux`, `liste_reseaux`, `galerie_photos`, `form_contact`, `form_recherche`, `calendrier`, `syndication`, `slider`, `id_page`) VALUES
(1, 3, 1, '0.9vw', 'Beew - webdesign cousu main', 'contact@beew.fr', 'contact@beew.fr', 2, '../img/logo.png', '../icones/favicon.png', 'Beew - webdesign cousu main', 'Bonjour,\r\n\r\nNous avons bien pris en compte votre demande.\r\nUne rÃ©ponse personnalisÃ©e va vous Ãªtre adressÃ©e dans les meilleurs dÃ©lais.\r\n\r\nCordialement\r\n\r\nCharles Duron', 'DermÃ©a - Technologie minceur anti-Ã¢ge', 'DermÃ©a - Technologie minceur anti-Ã¢ge, la combinaison de plusieurs mÃ©thodes pour un rÃ©sultat exceptionnel', 'oui', 'oui', '[[1,"oui","http://www.google.fr"],[2,"oui","http://www.google.fr"],[3,"oui","http://www.google.fr"],[4,"oui","https://www.linkedin.com/pub/charles-duron/54/219/b23"],[5,"oui","http://fr.viadeo.com/fr/profile/charles.duron"],[6,"oui","http://www.google.fr"],[7,"oui","http://www.google.fr"]]', 'oui', 'oui', 'oui', 'oui', 'oui', 'oui', 56);
...
(3, 1, 'la verge', 'http://www.theverge.com/rss/frontpage', 4, 'non'),
(4, 2, 'zebulon', 'http://www.zebulon.fr/RSS/actus.rss', 4, 'oui');
